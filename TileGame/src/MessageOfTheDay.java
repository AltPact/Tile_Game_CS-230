...
/**
 * This class is designed to allow the message of the day to be be obtained from
 * the website, as is prescribed in the design document. It should be instanced
 * and then the get result method can be called from the class.
 * 
...
public class MessageOfTheDay {
	...
	/**
	 * @private This method gets the puzzle in it's raw state.
	...
	/**
	 * @private This method gets the final message from the web.
	...
	/**
	 * @private This method solves the puzzle as is prescribed in API.
	 * @param input
	 * @return
	 */
